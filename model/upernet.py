...
class FeaturePyramidNet(nn.Module):
    ...
    def __init__(self, fpn_dim=256, size=[128, 256, 512], dim=[1024, 512, 256],
                 feature_name=['feature4', 'feature3', 'feature2', 'feature1'], down_size=512):
...
class UPerNet_Convnextv2_L(nn.Module):
    ...
    def __init__(self, fpn_dim=256, out_dim=1, output_size=2048):
        ...
        self.fpn = FeaturePyramidNet(self.fpn_dim,
                                     size=[output_size // 32, output_size // 16, output_size // 8, output_size // 4],
                                     dim=[1536, 768, 384, 192],
                                     feature_name=['feature4', 'feature3', 'feature2', 'feature1'],
                                     down_size=self.output_size // 4)
